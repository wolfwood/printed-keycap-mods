...
function lookup_chord_top_width_diff(key) = TopWidthDiff(name2id_chord(key));
function lookup_chord_height(key) = KeyHeight(name2id_chord(key));
function lookup_chord_topthickness() = topthickness();
